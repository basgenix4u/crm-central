    ...
    <div class="page-container">
      ...
      <div class="card" *ngIf="!loading">
        <table mat-table [dataSource]="items" class="data-table">
          ...
          <ng-container matColumnDef="actions"><th mat-header-cell *matHeaderCellDef></th><td mat-cell *matCellDef="let r"><button mat-icon-button [matMenuTriggerFor]="menu"><mat-icon>more_vert</mat-icon></button><mat-menu #menu="matMenu"><button mat-menu-item [routerLink]="[\"/customers\", r.id]"><mat-icon>visibility</mat-icon>View</button><button mat-menu-item (click)="delete(r.id)"><mat-icon>delete</mat-icon>Delete</button></mat-menu></td></ng-container>
...
export class CustomerListComponent implements OnInit {
  ...
  delete(id: string) {
    if (confirm('Are you sure?')) {
      this.api.delete('customers/' + id).subscribe({ next: () => { this.notify.success('Deleted successfully'); this.loadData(); } });
    }
  }
}
